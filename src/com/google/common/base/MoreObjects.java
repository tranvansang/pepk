...
public final class MoreObjects {
  ...
  public static final class ToStringHelper {
     ...
     * empty values; for example, empty strings or empty collections. The order of calling this
     * method, relative to the {@code add()}/{@code addValue()} methods, is not significant.
     */
    @CanIgnoreReturnValue
    @GoogleInternal
