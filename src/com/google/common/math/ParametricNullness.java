 ...
 *       (<b>Note:</b> The aforementioned Kotlin behavior exists in our open-source build only:
 *       Internally, type-variable usages have the right type under Kotlin, thanks to the JSpecify
 *       {@code @NullMarked}.)
