...
public abstract class FluentIterable<E extends @Nullable Object> implements Iterable<E> {
  ...
  @GoogleInternal
  @CheckForNull
  public final E getOnlyElement(@CheckForNull E defaultValue) {
    return Iterables.<@Nullable E>getOnlyElement(getDelegate(), defaultValue);
  }
  ...
  // TODO(kevinb): return FluentIterable<List<E>> instead
  @GoogleInternal
  public final FluentIterable<FluentIterable<@Nullable E>> partitionWithPadding(int size) {
