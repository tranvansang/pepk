...
public class ImmutableListMultimap<K, V> extends ImmutableMultimap<K, V>
   ...
   * <p>Android users: This method is available at {@link
   * AndroidAccessToCollectors#toImmutableListMultimap} in {@code
   * //java/com/google/common/collect:collect8-android}.
   ...
   * <!-- MOE:begin_intracomment_strip -->
   * <p>Android users: This method is available at {@link
   * AndroidAccessToCollectors#flatteningToImmutableListMultimap} in {@code
   * //java/com/google/common/collect:collect8-android}.
   * <!-- MOE:end_intracomment_strip -->
   *
   * @since 21.0
  ...
  // PUBLIC:begin_strip
  @PreferKotlinApi(
      replacement = "multimap.toImmutableListMultimap()",
      imports = "com.google.common.collect.toImmutableListMultimap")
  // PUBLIC:end_strip
  ...
  // PUBLIC:begin_strip
  @PreferKotlinApi(
      replacement = "entries.toImmutableListMultimap()",
      imports = {"com.google.common.collect.toImmutableListMultimap"})
  // PUBLIC:end_strip
  public static <K, V> ImmutableListMultimap<K, V> copyOf(
