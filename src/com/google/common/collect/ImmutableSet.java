...
public abstract class ImmutableSet<E> extends ImmutableCollection<E> implements Set<E> {
   ...
   * <p>Android users: This method is available at {@link AndroidAccessToCollectors#toImmutableSet}
  ...
  // PUBLIC:begin_strip
  @PreferKotlinApi(
      replacement = "elements.toImmutableSet()",
      imports = {"com.google.common.collect.toImmutableSet"})
  // PUBLIC:end_strip
