...
public class ImmutableSetMultimap<K, V> extends ImmutableMultimap<K, V>
   ...
   * AndroidAccessToCollectors#toImmutableSetMultimap} in {@code
   ...
   * <!-- MOE:begin_intracomment_strip -->
   * <p>Android users: This method is available at {@link
   * AndroidAccessToCollectors#flatteningToImmutableSetMultimap} in {@code
   * //java/com/google/common/collect:collect8-android}.
   * <!-- MOE:end_intracomment_strip -->
   *
   * @since 21.0
  ...
  // PUBLIC:begin_strip
  @PreferKotlinApi(
      replacement = "multimap.toImmutableSetMultimap()",
      imports = "com.google.common.collect.toImmutableSetMultimap")
  // PUBLIC:end_strip
  ...
  // PUBLIC:begin_strip
  @PreferKotlinApi(
      replacement = "entries.toImmutableSetMultimap()",
      imports = {"com.google.common.collect.toImmutableSetMultimap"})
  // PUBLIC:end_strip
  public static <K, V> ImmutableSetMultimap<K, V> copyOf(
