...
public final class Iterables {
   ...
   * ClassCastException}.
   */
  @PreferKotlinApi(replacement = "element in iterable") // PUBLIC:strip_line
   ...
   */
  @PreferKotlinApi(replacement = "iterable.single()") // PUBLIC:strip_line
  @ParametricNullness
  ...
  public static <A extends @Nullable Object, B extends @Nullable Object>
      Iterable<Pair<A, B>> pairUp(final Iterable<A> first, final Iterable<B> second) {
    checkNotNull(first);
    checkNotNull(second);
