...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
   ...
   * <p>Android users: This method is available at {@link AndroidAccessToCollectors#toImmutableMap}
   * in {@code //java/com/google/common/collect:collect8-android}.
  ...
  public static class Builder<K, V> {
    ...
    // PUBLIC:begin_strip
    @Deprecated
    @InlineMeValidationDisabled("Overriding build() is very unusual")
    @InlineMe(replacement = "this.buildOrThrow()")
    // PUBLIC:end_strip
  ...
  // PUBLIC:begin_strip
  @PreferKotlinApi(
      replacement = "map.toImmutableMap()",
      imports = {"com.google.common.collect.toImmutableMap"})
  // PUBLIC:end_strip
  ...
  // PUBLIC:begin_strip
  @PreferKotlinApi(
      replacement = "entries.toImmutableMap()",
      imports = {"com.google.common.collect.toImmutableMap"})
  // PUBLIC:end_strip
