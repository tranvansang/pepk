...
public final class Streams {
  ...
  @Beta
  @PreferStaticImport // MOE:strip_line
  // PUBLIC:insert @InlineMe(replacement = "optional.stream()")
  // PUBLIC:insert @com.google.errorprone.annotations.InlineMeValidationDisabled("Java 9+ API only")
  ...
  public static <T extends @Nullable Object> Iterable<T> iterating(Stream<T> stream) {
